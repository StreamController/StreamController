...
class DeckStackChild(Gtk.Overlay):
    ...
    def build(self):
        ...
        self.toggle_settings_button = Gtk.Button(icon_name="com.core447.StreamController_configure", css_classes=["circular"],
    ...
    def on_toggle_settings_button_click(self, button):
        if self.stack.get_visible_child_name() == "page-settings":
            ...
            self.toggle_settings_button.set_icon_name("com.core447.StreamController_configure")
