...
class UIPage(Adw.PreferencesPage):
    def __init__(self, settings: Settings):
        ...
        self.set_icon_name("com.core447.StreamController_focus-windows-symbolic")
...
class DevPage(Adw.PreferencesPage):
    def __init__(self, settings: Settings):
        ...
        self.set_icon_name("com.core447.StreamController_code-block")
...
class StorePage(Adw.PreferencesPage):
    def __init__(self, settings: Settings):
        ...
        self.set_icon_name("com.core447.StreamController_go-home-symbolic")
...
class PerformancePage(Adw.PreferencesPage):
    def __init__(self, settings: Settings):
        ...
        self.set_icon_name("com.core447.StreamController_kt-speed-limits")
