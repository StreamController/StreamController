...
class ChooserPage(Gtk.Box):
    ...
    def _build(self):
        ...
        self.video_button = Gtk.ToggleButton(icon_name="com.core447.StreamController_view-list-video-symbolic", css_classes=["blue-toggle-button"])
        self.video_button.connect("toggled", self.on_video_toggled)
        self.type_box.append(self.video_button)

        self.image_button = Gtk.ToggleButton(icon_name="com.core447.StreamController_view-list-images-symbolic", css_classes=["blue-toggle-button"])
