...
class StorePreview(Gtk.FlowBoxChild):
    ...
    def build(self):
        ...
        self.github_button = Gtk.Button(icon_name="com.core447.StreamController-folder-github",
                                        hexpand=True,
        ...
        self.install_uninstall_button = Gtk.Button(icon_name="com.core447.StreamController-edit-download",
                                          hexpand=True,
    ...
    def set_install_state(self, state: int):
        ...
        if state == 0:
            self.install_uninstall_button.set_icon_name("com.core447.StreamController-browser-download-symbolic")
            ...
            self.install_uninstall_button.set_icon_name("com.core447.StreamController-user-trash")

            self.install_uninstall_button.add_css_class("red-background")
            self.install_uninstall_button.remove_css_class("confirm-button")

        elif state == 2:
            self.install_uninstall_button.set_icon_name("com.core447.StreamController-software-update-available-symbolic")
