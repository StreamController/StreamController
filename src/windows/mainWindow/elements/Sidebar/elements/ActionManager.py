...
class ActionExpanderRow(BetterExpander):
    ...
    def reorder_actions(self, move_index, after_index):
        ...
        image_control_action_index = controller.active_page.dict["keys"][page_coords]["states"][str(self.active_state)].get("image-control-action")
        controller.active_page.dict["keys"][page_coords]["states"][str(self.active_state)]["image-control-action"] = action_order_map.get(image_control_action_index, None)
        ...
        controller.active_page.dict["keys"][page_coords]["states"][str(self.active_state)]["label-control-actions"] = label_control_actions
