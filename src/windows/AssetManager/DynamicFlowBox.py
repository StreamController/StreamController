...
class DynamicFlowBox(Gtk.Box):
    ...
    def build(self):
        ...
        self.back_button = Gtk.Button(icon_name="com.core447.StreamController-go-previous")
        ...
        self.next_button = Gtk.Button(icon_name="com.core447.StreamController-go-next")
