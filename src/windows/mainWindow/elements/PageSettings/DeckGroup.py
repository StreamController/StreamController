...
from src.windows.mainWindow.elements.PageSettings.DeckGroupParts.Brightness import Brightness
from src.windows.mainWindow.elements.PageSettings.DeckGroupParts.Screensaver import Screensaver
