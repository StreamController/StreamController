...
class SDPlusBarWallpaperChooserPage(ChooserPage):
    ...
    def build(self):
        ...
        self.wallpaper_flow = SDPlusBarWallpaperFlowBox(SDPlusBarWallpaperPreview, self)
    ...
    def load_for_pack(self, pack: "SDPlusBarWallpaperPack"):
    ...
    def preview_factory(self, preview: SDPlusBarWallpaperPreview, wallpaper):
