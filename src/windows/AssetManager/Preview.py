...
class Preview(Gtk.FlowBoxChild):
    ...
    def _build(self):
        ...
        self.info_button = Gtk.Button(icon_name="com.core447.StreamController-help-info-symbolic", halign=Gtk.Align.END, valign=Gtk.Align.END, margin_end=5, margin_bottom=5)
