...
class OnboardingWindow(Gtk.ApplicationWindow):
    ...
    def build(self):
        ...
        self.forward_button = Gtk.Button(icon_name="com.core447.StreamController_go-next-symbolic", css_classes=["onboarding-nav-button", "circular"],
        ...
        self.back_button = Gtk.Button(icon_name="com.core447.StreamController_go-previous-symbolic", css_classes=["onboarding-nav-button", "circular"],
