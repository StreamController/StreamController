...
class PagesGroup(BetterPreferencesGroup):
    ...
    def load_pages(self):
        ...
        row1.add_suffix(Gtk.Button(icon_name="com.core447.StreamController-open-menu-symbolic", css_classes=["flat"], vexpand=False, valign=Gtk.Align.CENTER))
...
class AdwPageRow(Adw.PreferencesRow):
    def __init__(self, pages_group:PagesGroup, page_path:str = None):
        ...
        self.active_icon = Gtk.Image(icon_name="com.core447.StreamController-object-select-symbolic", css_classes=["flat"], margin_start=3, visible=False)
        self.main_box.append(self.active_icon)

        self.edit_button = Gtk.Button(icon_name="com.core447.StreamController-edit-symbolic", halign=Gtk.Align.END, css_classes=["flat"], hexpand=True)
