...
class ActionRow(Adw.PreferencesRow):
    ...
    def build(self):
        ...
        self.up_button = Gtk.Button(icon_name="com.core447.StreamController_go-up-symbolic")
        self.up_button.connect("clicked", self.on_click_up)
        self.button_box.append(self.up_button)

        self.down_button = Gtk.Button(icon_name="com.core447.StreamController_go-down-symbolic")
...
class MissingActionButtonRow(Adw.PreferencesRow):
    def __init__(self, action_id:str, page_coords:str, index:int):
        ...
        self.remove_button = Gtk.Button(icon_name="com.core447.StreamController_entry-delete", vexpand=False, halign=Gtk.Align.END, css_classes=["red-background"], margin_end=0,
